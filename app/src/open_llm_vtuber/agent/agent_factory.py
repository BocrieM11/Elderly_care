        ...
        **kwargs,
        ...
        if conversation_agent_choice == "basic_memory_agent":
            ...
            return BasicMemoryAgent(
                ...
                visual_observer_enabled=basic_memory_settings.get(
                    "visual_observer_enabled", True
                ),
                visual_observer_current_frames=basic_memory_settings.get(
                    "visual_observer_current_frames", 2
                ),
                visual_observer_temporal_frames=basic_memory_settings.get(
                    "visual_observer_temporal_frames", 6
                ),
            )
