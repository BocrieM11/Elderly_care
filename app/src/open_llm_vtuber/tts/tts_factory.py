    ...
    def get_tts_engine(engine_type, **kwargs) -> Type[TTSInterface]:
        if engine_type == "azure_tts":
            ...
            return Cosyvoice2TTSEngine(
                ...
                api_name=kwargs.get("api_name"),
                voice_cache_id=kwargs.get("voice_cache_id", ""),
            )
        elif engine_type == "fish_speech_local_tts":
            from .fish_speech_local_tts import TTSEngine as FishSpeechLocalTTSEngine

            return FishSpeechLocalTTSEngine(
                base_url=kwargs.get("base_url"),
                reference_id=kwargs.get("reference_id", "olv_263_oral5"),
                sample_rate=kwargs.get("sample_rate", 44100),
                chunk_length=kwargs.get("chunk_length", 100),
                chunk_seconds=kwargs.get("chunk_seconds", 0.8),
